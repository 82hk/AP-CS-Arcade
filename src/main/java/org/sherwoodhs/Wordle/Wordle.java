...
public class Wordle {
    ...
    public String getWord(){
        ...
        try {
            return Files.readAllLines(Paths.get("src/main/java/org/sherwoodhs/Wordle/RandomWords")).get(random_int);
        }
        catch(IOException e){
    ...
    public boolean checkWord(String[] g){
        File file = new File("src/main/java/org/sherwoodhs/Wordle/6letters.txt");
        FileReader in;
